...
!function (e) {
    ...
    o.e = function (e) {
        ...
        ,
        o.p = "//g.alicdn.com/alipic-lark/larkportal-front/3.0.152/",
        o.oe = function (e) {
            throw e
        }
    ;
...
function get_encrypted_pwd(password) {
    var r = run(3),
        i = r(run(2132)),
        s = {
    ...
    return i.default.encryptedString(c, encodeURIComponent(password))
}

console.log(get_encrypted_pwd('123456'))